...
def create_app(test_config=None):
  ...
  def add_question():
    ...
    #no data in request abort
    if not ('question' in request_data and 'answer' in request_data and 'difficulty' in request_data and 'category' in request_data and 
    request_data.get('question') != '' and request_data.get('answer') != '' and request_data.get('difficulty') != '' and request_data.get('category') != ''):
      abort(422)
  ...
  def play_quiz():
    ...
    try:
      ...
      if category['type'] == 'click' :
        ...
        available_questions = Question.query.filter_by(category=category['id']).filter(~Question.id.in_(previous_questions)).all()
